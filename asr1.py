...
from character import Char2idx
from character import Idx2char
from phone import Idx2phone
from phone import Phone2idx
from word import Idx2word
from word import Word2idx
from wordpiece import Idx2wp
from wordpiece import Wp2idx
...
class Dataset(object):
    ...
    def __init__(self, tsv_path, dict_path,
                 ...
                 discourse_aware=False, skip_thought=False,offset=0,epoch=0):
    ...
    def sample_index(self, batch_size):
        ...
        is_new_epoch = False
#        print(self.offset)
#        print(self.df_indices)
        for i in range(0,self.offset):
            if i in self.df_indices:
                self.df_indices.remove(i)
#                print(i)
#        print(self.df_indices)   #for debug

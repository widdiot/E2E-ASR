...
trainset = Dataset(corpus='hindi',
                   tsv_path="/home/neural_sp/examples/400_hindi/s5/data/dataset/train370_wpbpe10000.tsv",
                   dict_path="/home/neural_sp/examples/400_hindi/s5/data/dict/train370_wpbpe10000.txt",
                   unit='wp',
                   wp_model="/home/neural_sp/examples/400_hindi/s5/data/dict/train370_bpe10000.model",
...
evalset = Dataset(corpus='hindi',
                 tsv_path="/home/neural_sp/examples/400_hindi/s5/data/dataset/dev15_wpbpe10000.tsv",
                 dict_path="/home/neural_sp/examples/400_hindi/s5/data/dict/train370_wpbpe10000.txt",
                 unit='wp',
                 wp_model="/home/neural_sp/examples/400_hindi/s5/data/dict/train370_bpe10000.model",
                 batch_size=args.batch_size,  # * args.n_gpus,
...
model = Transducer(81*args.n_stack, vocab, 256, 3, args.dropout, bidirectional=args.bi)
print(model)
for param in model.parameters():
    torch.nn.init.uniform(param, -0.1, 0.1)
if args.init: model.load_state_dict(torch.load(args.init,map_location='cpu'))
